export const es = {
  ...
  // Common
  common: {
    getDemo: 'Recibir demo + cotización',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Sí. Ofrecemos 14 días de garantía de devolución. Si no estás satisfecho con el servicio, te devolvemos tu dinero sin preguntas.',
      },
    ],
  },
  ...
  pricing: {
    ...
    price: '$299',
    priceUnit: 'USD/mes',
    noContracts: 'Sin contratos. Cancela cuando quieras.',
  },
