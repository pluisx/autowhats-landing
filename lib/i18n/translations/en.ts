  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'The bot automatically detects when a conversation needs to be transferred to a real person. It notifies you via WhatsApp and you can take control of the conversation at any time.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes, as long as you use the official WhatsApp Business API. AutoWhats works exclusively with official Meta-approved providers, so your account is completely safe.',
      },
      {
        question: 'Do you offer a guarantee?',
        answer: 'Yes. We offer a 14-day money-back guarantee. If you\'re not satisfied with the service, we\'ll refund your money, no questions asked.',
      },
    ],
  },
