...
export const metadata: Metadata = {
  ...
  title: "AutoWhats | Recupera Carritos Abandonados y Automatiza tu Tienda con WhatsApp",
  description: "Automatiza el WhatsApp de tu tienda online. Recupera carritos abandonados, envía actualizaciones de pedidos y atiende clientes 24/7 — sin contratar más personal. Desde $299/mes.",
  keywords: [
    // Keywords e-commerce
    "automatizar whatsapp tienda online",
    "recuperar carritos abandonados whatsapp",
    "bot whatsapp ecommerce",
    "whatsapp para tiendas online",
    "chatbot whatsapp shopify",
    "automatizar soporte clientes whatsapp",
    ...
    // Keywords long-tail
    "como recuperar carritos abandonados con whatsapp",
    "bot whatsapp para tienda online",
    "automatizar atencion cliente whatsapp ecommerce",
    "whatsapp business para ecommerce",
    "notificaciones pedidos whatsapp automatico",
  ...
  openGraph: {
    ...
    siteName: "AutoWhats",
    title: "Recupera Carritos Abandonados con WhatsApp | AutoWhats",
    description: "El 70% de los carritos se abandonan. AutoWhats los recupera automáticamente con WhatsApp — más seguimiento de pedidos, soporte 24/7 y devoluciones sin fricción.",
    images: [
      {
        url: "/og-image.svg",
        width: 1200,
        height: 630,
        alt: "AutoWhats - Automatiza el WhatsApp de tu Tienda Online",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Automatiza el WhatsApp de tu Tienda | AutoWhats",
    description: "Recupera carritos abandonados, actualiza pedidos y atiende clientes 24/7 con WhatsApp. Sin contratar más personal. Desde $299/mes.",
    images: ["/og-image.svg"],
  },
  robots: {
    index: true,
...
})(window,document,'script','dataLayer','GTM-KWMZ347J');`,
          }}
        />
        {/* End Google Tag Manager */}
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-H0NKHH0SDK" />
        <script
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-H0NKHH0SDK');`,
          }}
        />
        {/* End Google tag */}
        <script
      ...
      <body className="antialiased">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KWMZ347J"
            height="0"
            width="0"
